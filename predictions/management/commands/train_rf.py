...
class Command(BaseCommand):
    help = 'Train a RandomForest classifier from a CSV (last column as target by default) and save to predictions/rf_model.joblib'
    ...
    def add_arguments(self, parser: CommandParser) -> None:
        ...
        parser.add_argument('--labels', default=None, help='Comma-separated labels for classes in ascending class order (e.g., "no disease, disease")')
    ...
    def handle(self, *args, **options):
        ...
        labels_arg: Optional[str] = options['labels']
        ...
        try:
            ...
            self.stderr.write(self.style.ERROR(f'Non-numeric data encountered: {e}'))
            return
        ...
        meta = {'feature_names': feature_names, 'target': target, 'accuracy': float(acc), 'labels': labels}
